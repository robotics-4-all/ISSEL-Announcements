...
- [TH-17/ Εφαρμογή τεχνολογιών Blockchain για τη δημιουργία αποκεντρωμένης αγοράς υπολογιστικής ισχύς από edge συσκευές](#th-17)
- [TH-18/ Ανάπτυξη διαδικτυακής πλατφόρμας για πράκτορες εξόρυξης ρευστότητας σε κρυπτονομίσματα](#th-19)
...
## TH-17
**Εφαρμογή τεχνολογιών Blockchain για τη δημιουργία αποκεντρωμένης αγοράς υπολογιστικής ισχύς από edge συσκευές**
...
Η τεχνολογία blockchain θα μπορούσε να χρησιμοποιηθεί για τη δημιουργία μιας αποκεντρωμένης αγοράς υπολογιστικής ισχύς (από edge devices), που να συνδέει τους προμηθευτές της εκάστοτε υποδομής edge με αυτούς που το απαιτούν, χωρίς κάποιο κεντρικό σημείο ελέγχου.
Στα πλαίσια της παρούσας διπλωματικής εργασίας θα μελετηθούν εφαρμογές των δικτύων blockchain για τη δημιουργία αποκεντρωμένης αγοράς υπολογιστικής ισχύς από edge συσκευές.
...
Στα πλαίσια της παρούσας διπλωματικής εργασίας θα αναπτυχθεί μια διαδικτυακή πλατφόρμα η οποία θα επιτρέπει την παρακολούθηση και τη διαχείριση πρακτορων εξόρυξης ρευστότητας σε κρυπτονομίσματα, χρησιμοποιώντας έτοιμα εργαλεία εξόρυξης ρευστότητας (hummingbot).
