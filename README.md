...
Στα πλαίσια της συγκεκριμένης διπλωματικής εργασίας θα μελετηθούν εφαρμογές των δικτύων blockchain για τη δημιουργία αποκεντρωμένης αγοράς υπολογιστικής ισχύς από edge συσκευές.
